...
public abstract class Easing {
   ...
   public static final Easing EXPO_IN_OUT = new Easing("expoInOut") {
      ...
      public float ease(float t, float b, float c, float d) {
         if (t == 0.0F) {
            ...
            float var5;
            return (var5 = t / (d / 2.0F)) < 1.0F
               ? c / 2.0F * (float)Math.pow(2.0, (double)(10.0F * (var5 - 1.0F))) + b
               : c / 2.0F * (-((float)Math.pow(2.0, (double)(-10.0F * --var5))) + 2.0F) + b;
         }
      }
   };
   ...
   public static final Easing CIRC_IN_OUT = new Easing("circInOut") {
      ...
      public float ease(float t, float b, float c, float d) {
         ...
         float var6;
         return (var5 = t / (d / 2.0F)) < 1.0F
            ? -c / 2.0F * ((float)Math.sqrt((double)(1.0F - var5 * var5)) - 1.0F) + b
            : c / 2.0F * ((float)Math.sqrt((double)(1.0F - (var6 = var5 - 2.0F) * var6)) + 1.0F) + b;
      }
   };
