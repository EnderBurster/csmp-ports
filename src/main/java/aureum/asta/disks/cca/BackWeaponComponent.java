...
public class BackWeaponComponent implements AutoSyncedComponent {
    ...
    public static ItemStack getBackWeapon(PlayerEntity player) {
        return ((BackWeaponComponent)ArsenalComponents.BACK_WEAPON_COMPONENT.get(player)).getBackWeapon();
    }
    ...
    public static boolean setBackWeapon(PlayerEntity player, ItemStack backWeapon) {
        return ((BackWeaponComponent)ArsenalComponents.BACK_WEAPON_COMPONENT.get(player)).setBackWeapon(backWeapon);
    }
    ...
    public static SimpleInventory getBackWeaponInventory(PlayerEntity player) {
        return ((BackWeaponComponent)ArsenalComponents.BACK_WEAPON_COMPONENT.get(player)).getBackWeaponInventory();
    }
    ...
    public static boolean isHoldingBackWeapon(PlayerEntity player) {
        return ((BackWeaponComponent)ArsenalComponents.BACK_WEAPON_COMPONENT.get(player)).isHoldingBackWeapon();
    }
    ...
    public static void setHoldingBackWeapon(PlayerEntity player, boolean holdingBackWeapon) {
        if (player.getWorld().isClient()) {
            ...
            ClientPlayNetworking.send(AureumAstaDisks.SERVERBOUND_HOLD_WEAPON_PACKET, buf);
        } else {
            ((BackWeaponComponent)ArsenalComponents.BACK_WEAPON_COMPONENT.get(player)).setHoldingBackWeapon(holdingBackWeapon);
        }
    }
}
