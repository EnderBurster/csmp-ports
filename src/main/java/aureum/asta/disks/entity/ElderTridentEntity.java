...
public class ElderTridentEntity extends ImpaledTridentEntity {
    ...
    protected net.minecraft.entity.Entity tridentTarget;
    ...
    public void tick() {
        ...
        List<net.minecraft.entity.Entity> list = this.world.getOtherEntities(this, box);
    ...
    public void onPlayerCollision(PlayerEntity player) {
        ...
        net.minecraft.entity.Entity entity = this.getOwner();
