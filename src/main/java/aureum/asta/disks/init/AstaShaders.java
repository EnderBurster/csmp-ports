...
public class AstaShaders {
    ...
    public static void init(ResourceFactory manager) throws IOException {
        ...
        registerShader(ExtendedShader.createShaderInstance(BORDER_RADIAL, manager, AureumAstaDisks.id("border/border_radial"), VertexFormats.POSITION_COLOR_TEXTURE));
        registerShader(ExtendedShader.createShaderInstance(BORDER_LINEAR, manager, AureumAstaDisks.id("border/border_linear"), VertexFormats.POSITION_COLOR_TEXTURE));
        registerShader(ExtendedShader.createShaderInstance(BORDER_BOTTOM, manager, AureumAstaDisks.id("border/border_bottom"), VertexFormats.POSITION_COLOR_TEXTURE));
    }
