package aureum.asta.disks.client.render.model;// Made with Blockbench 4.1.5
...
public class FrogOnHeadModel extends Model {
    ...
    private final net.minecraft.client.model.ModelPart frog;

    public FrogOnHeadModel(net.minecraft.client.model.ModelPart root) {
    ...
    public void setRotationAngle(net.minecraft.client.model.ModelPart bone, float x, float y, float z) {
        bone.pitch = x;
        bone.yaw = y;
        bone.roll = z;
    }
