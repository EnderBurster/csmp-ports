...
public class GrimoirePageEntityRenderer<T extends PageEntity> extends EntityRenderer<T> {
    public static final Identifier TEXTURE = new Identifier("aureum-asta-disks", "textures/entity/blood_scythe.png");

    public GrimoirePageEntityRenderer(EntityRendererFactory.Context context) {super(context);}
