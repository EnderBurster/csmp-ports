...
public class GrimoireVortexProjectileEntityRenderer<T extends VortexProjectileEntity> extends EntityRenderer<T> {
    public static final Identifier TEXTURE = new Identifier("aureum-asta-disks", "textures/entity/blood_scythe.png");

    public GrimoireVortexProjectileEntityRenderer(EntityRendererFactory.Context context) {super(context);}
