...
public class SparkParticle extends Particle {
	...
	private void drawFace(VertexConsumer consumer, Matrix4f matrix4f, float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4) {
		consumer.vertex(matrix4f, x1, y1, z1).color(red, green, blue, alpha).next();
		consumer.vertex(matrix4f, x2, y2, z2).color(red, green, blue, alpha).next();
		consumer.vertex(matrix4f, x3, y3, z3).color(red, green, blue, alpha).next();
		consumer.vertex(matrix4f, x4, y4, z4).color(red, green, blue, alpha).next();
