...
import aureum.asta.disks.client.render.entity.ImpaledTridentEntityRenderer;
import aureum.asta.disks.client.render.entity.model.ImpaledTridentEntityModel;
import aureum.asta.disks.ports.impaled.Impaled;
import aureum.asta.disks.ports.impaled.init.ImpaledEntityTypes;
import aureum.asta.disks.ports.impaled.init.ImpaledItems;
import aureum.asta.disks.ports.impaled.item.ImpaledTridentItem;
...
public class ImpaledClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ModItemGroup.ImpaledGroup).register((content) -> {
