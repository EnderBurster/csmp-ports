...
public class WindChargeItem extends Item {
   ...
   public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
      ...
      world.playSound((PlayerEntity)null, user.getX(), user.getY(), user.getZ(), FaithfulMace.ENTITY_WIND_CHARGE_THROW_SOUND_EVENT, SoundCategory.NEUTRAL, 0.5F, 0.4F / (world.getRandom().nextFloat() * 0.4F + 0.8F));
