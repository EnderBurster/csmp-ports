...
import aureum.asta.disks.ports.charter.client.shaders.CharterShaders;
...
public class DominanceRenderer {
    private static final Identifier DOMINANCE = Charter.id("textures/misc/divine_dominance_barrier.png");
    ...
    public static void drawBaseCube(MatrixStack matrices, float size, Vec3d pos)
    {
        ...
        Supplier<ShaderProgram> linearShader = CharterShaders.BORDER_LINEAR.getInstance();
        Supplier<ShaderProgram> radialShader = CharterShaders.BORDER_RADIAL.getInstance();
        RenderSystem.setShaderTexture(0, DOMINANCE);
        ...
        Vector4f foreground = new Vector4f(0.922f, 0.792f, 0.369f, 0.8f);
        Vector4f background = new Vector4f(0.302f, 0.302f, 0.302f, 0.4f);
    ...
    public static class CustomRenderLayers {
        public static final RenderLayer UNGLOWED_QUADS = RenderLayer.of(
                "elysium:unglowed_quads",
