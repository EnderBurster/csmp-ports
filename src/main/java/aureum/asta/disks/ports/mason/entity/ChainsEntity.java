...
public class ChainsEntity extends HostileEntity implements GeoAnimatable {
    ...
    public boolean damage(DamageSource source, float amount) {
        ...
        if ((!(source.getAttacker() == this.getFirstPassenger()) && amount >= 6) || source.isIn(DamageTypeTags.IS_EXPLOSION) || source.isIn(DamageTypeTags.IS_FIRE) || source.isSourceCreativePlayer()) {
            this.discard();
        }
        return true;
    }
