...
public class TamedFollowOwnerGoal<T extends HostileEntity & TameableHostileEntity> extends Goal {
    ...
    public boolean shouldContinue() {
        if (this.navigation.isIdle()) {
            ...
            return this.tameable.squaredDistanceTo(this.owner) > (double) (this.maxDistance * this.maxDistance) || this.tameable.getY() >= owner.getY();
        }
    }
