...
import aureum.asta.disks.ports.mason.MasonDecorClient;
import aureum.asta.disks.ports.mason.entity.goal.RavenDeliverBundleGoal;
import aureum.asta.disks.ports.mason.entity.goal.RavenFollowOwnerGoal;
...
public class RavenEntity extends TameableEntity implements GeoAnimatable {
    ...
    @Override
    protected void initEquipment(net.minecraft.util.math.random.Random randomGenerator, LocalDifficulty difficulty) {
    ...
    public enum Type {
        ...
        public static Type getRandomType(net.minecraft.util.math.random.Random random) {
            int totalWeight = 0;
