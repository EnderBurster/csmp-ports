...
import aureum.asta.disks.ports.mason.entity.RavenEntity;
...
public class RavenEntityModel extends GeoModel<RavenEntity> {
    ...
    public Identifier getModelResource(RavenEntity object) {
        return new Identifier("aureum-asta-disks", "geo/entity/raven.geo.json");
    }

    public Identifier getTextureResource(RavenEntity object) {
        return new Identifier("aureum-asta-disks", "textures/entity/raven/raven_" + object.getRavenType().toString().toLowerCase() + ".png");
    }

    public Identifier getAnimationResource(RavenEntity animatable) {
        return new Identifier("aureum-asta-disks", "animations/entity/raven.animation.json");
    }
