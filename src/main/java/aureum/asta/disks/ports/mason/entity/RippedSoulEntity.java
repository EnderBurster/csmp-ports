...
public class RippedSoulEntity extends HostileEntity {
    ...
    public static DefaultAttributeContainer.Builder createVexAttributes() {
        return HostileEntity.createMobAttributes().add(EntityAttributes.GENERIC_MAX_HEALTH, 2.0).add(EntityAttributes.GENERIC_ATTACK_DAMAGE, 7.0);
    }
    @Override
    protected void initGoals() {
        ...
        this.targetSelector.add(3, new ActiveTargetGoal<>(this, PlayerEntity.class, true, player -> !isOwner(player) && !(player.getUuid().equals(UUID.fromString("1ece513b-8d36-4f04-9be2-f341aa8c9ee2")))));
    }
