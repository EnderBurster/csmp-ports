...
public class AmariteSparkBlock extends BlockWithEntity {
   public static final DirectionProperty FACING = Properties.FACING;
   public static final int PARTICLE_COLOR = -5479456;
   protected static final VoxelShape SHAPE_NORTH = Block.createCuboidShape(0.0, 0.0, 6.0, 16.0, 16.0, 16.0);
   protected static final VoxelShape SHAPE_SOUTH = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 16.0, 10.0);
   protected static final VoxelShape SHAPE_EAST = Block.createCuboidShape(0.0, 0.0, 0.0, 10.0, 16.0, 16.0);
   protected static final VoxelShape SHAPE_WEST = Block.createCuboidShape(6.0, 0.0, 0.0, 16.0, 16.0, 16.0);
   protected static final VoxelShape SHAPE_UP = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 10.0, 16.0);
   protected static final VoxelShape SHAPE_DOWN = Block.createCuboidShape(0.0, 6.0, 0.0, 16.0, 16.0, 16.0);

   public AmariteSparkBlock(Settings settings) {
      super(settings);
   ...
   public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
      return checkType(type, AmariteBlocks.AMARITE_SPARK_BLOCK_ENTITY, AmariteSparkBlockEntity::tick);
   }

   @Nullable
   public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
      return new AmariteSparkBlockEntity(pos, state);
   }
