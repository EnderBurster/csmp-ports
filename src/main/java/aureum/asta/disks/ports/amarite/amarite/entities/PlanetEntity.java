...
public class PlanetEntity extends PersistentProjectileEntity {
   public static final float BASE_DAMAGE = 3.0F;
   public LivingEntity trackingTarget;

   public PlanetEntity(EntityType<? extends PlanetEntity> entityType, World world) {
   ...
   public static boolean isValidTarget(@NotNull PlanetEntity entity, @Nullable Entity target) {
