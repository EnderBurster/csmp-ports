...
public class BeamEntity extends PersistentProjectileEntity {
   ...
   protected void onEntityHit(EntityHitResult entityHitResult) {
      ...
      if (target.damage(AmariteDamageTypes.of(this.world, AmariteDamageTypes.A_DISC), 3.0F)) {
   ...
   public static boolean isValidTarget(@NotNull BeamEntity entity, @Nullable Entity target) {
