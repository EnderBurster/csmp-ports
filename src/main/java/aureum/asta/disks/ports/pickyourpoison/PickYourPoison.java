package aureum.asta.disks.ports.pickyourpoison;
...
import aureum.asta.disks.item.PoisonDartFrogBowlItem;
import aureum.asta.disks.item.ThrowingDartItem;
import aureum.asta.disks.ports.pickyourpoison.effect.EmptyStatusEffect;
import aureum.asta.disks.ports.pickyourpoison.effect.NumbnessStatusEffect;
...
//        ServerLifecycleEvents.SERVER_STOPPING.register(server -> FROGGY_PLAYERS.clear());
        ...
        ItemGroupEvents.modifyEntriesEvent(ModItemGroup.Poison).register((entries) -> entries.addAll(Stream.of(
